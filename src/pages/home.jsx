...
const Home = () => {
  ...
  const whyCards = [
    {
      id: 0, title: t('why_card1_t'),
      description: t('why_card1_d'),
    ...
    {
      id: 1, title: t('why_card2_t'),
      description: t('why_card2_d'),
    ...
    {
      id: 2, title: t('why_card3_t'),
      description: t('why_card3_d'),
      ...
      <div className="signup-bg">
        ...
        <div className="py-24 md:py-28 px-6 md:px-12">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-[32px] md:text-[46px] gradient-title mb-5 leading-tight">{t('why_title')}</h2>
        ...
        <div className="pt-4 pb-10 px-6 md:px-12 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-[32px] md:text-[46px] gradient-title mb-5 leading-tight">{t('prod_title')}</h2>
